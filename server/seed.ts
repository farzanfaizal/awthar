...
const seedCategories = [
  {
    ...
    slug: "home-repair",
    descriptionEn: "Plumbing, electrical, AC servicing, and general home repairs by certified professionals",
    descriptionAr: "السباكة والكهرباء وصيانة التكييف والإصلاحات المنزلية العامة",
    iconName: "Wrench",
    displayOrder: 1,
  },
  {
    ...
    slug: "cleaning",
    descriptionEn: "Deep cleaning, regular housekeeping, office cleaning, and specialized sanitization",
    descriptionAr: "التنظيف العميق وخدمات التدبير المنزلي وتنظيف المكاتب",
    iconName: "Sparkles",
    displayOrder: 2,
  },
  {
    nameEn: "Moving & Relocation",
    nameAr: "النقل والانتقال",
    slug: "moving",
    descriptionEn: "Professional movers for homes and offices with packing, storage, and delivery services",
    descriptionAr: "شركات نقل محترفة للمنازل والمكاتب مع التعبئة والتخزين",
    iconName: "Truck",
    displayOrder: 3,
  },
  {
    ...
    slug: "technology",
    descriptionEn: "Computer repair, network setup, software support, and smart home installation",
    descriptionAr: "إصلاح الكمبيوتر وإعداد الشبكات ودعم البرمجيات",
    iconName: "Laptop",
    displayOrder: 4,
  },
  {
    ...
    slug: "personal",
    descriptionEn: "Fitness trainers, beauty services, massage therapy, and wellness treatments",
    descriptionAr: "مدربي اللياقة البدنية وخدمات التجميل والعلاج بالتدليك",
    iconName: "Heart",
    displayOrder: 5,
  },
  {
    ...
    slug: "education",
    descriptionEn: "Private tutors, language lessons, exam preparation, and skill development courses",
    descriptionAr: "مدرسون خصوصيون ودروس لغة وتحضير للامتحانات",
  ...
  },
  {
    ...
    slug: "consulting",
    descriptionEn: "Legal, accounting, marketing, and business consulting for companies and startups",
    descriptionAr: "الخدمات القانونية والمحاسبة والتسويق للشركات",
    iconName: "Briefcase",
    displayOrder: 7,
  },
  {
    nameEn: "Events & Photography",
    nameAr: "المناسبات والتصوير",
    slug: "events",
    descriptionEn: "Event planning, photography, videography, and entertainment for all occasions",
    descriptionAr: "تخطيط المناسبات والتصوير الفوتوغرافي والفيديو",
    iconName: "Camera",
    displayOrder: 8,
  },
];
